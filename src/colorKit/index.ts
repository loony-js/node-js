...
export const colorKitUI = () => {
  ...
  const detectColorFormat = (
    ...
    if (typeof color === "object") {
      ...
      const isRgbaOb = rgbaKeys.every(
        (k) =>
          Object.prototype.hasOwnProperty.call(color, k) &&
          typeof (color as rgbaT)[k] === "number",
      )
      ...
      const isHslaOb = hslaKeys.every(
        (k) =>
          Object.prototype.hasOwnProperty.call(color, k) &&
          typeof (color as hslaT)[k] === "number",
      )
      ...
      const isHsvaOb = hsvaKeys.every(
        (k) =>
          Object.prototype.hasOwnProperty.call(color, k) &&
          typeof (color as hsvaT)[k] === "number",
      )
      ...
      const isHwbaOb = hwbaKeys.every(
        (k) =>
          Object.prototype.hasOwnProperty.call(color, k) &&
          typeof (color as hwbaT)[k] === "number",
      )
  ...
  const HEX = (color: SupportedColorFormats): string => {
    ...
    if (typeof color === "string") {
      ...
      if (Object.prototype.hasOwnProperty.call(NAMED_COLORS, color)) {
